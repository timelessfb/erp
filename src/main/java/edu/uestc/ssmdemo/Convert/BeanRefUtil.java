...
/**
 * Created by hu on 2018-04-26.
 */

public class BeanRefUtil {


    private static HashSet<String> filterField;
    public static void TasktableVo2Tasktable(Object from,Object to){
        filterField = new HashSet<String>();
        filterField.add("process");
        Map<String, String> fieldValueMap = getFieldValueMap(from);
        setFieldValue(to,fieldValueMap);
    }
    ...
    public static Map<String, String> getFieldValueMap(Object bean) {
        ...
        for (Field field : fields) {
            try {
                ...
                if (!checkGetMet(methods, fieldGetName) ||filterField.contains(field.getName())) {
                    continue;
                }
    ...
    public static void setFieldValue(Object bean, Map<String, String> valMap) {
        ...
        for (Field field : fields) {
            try {
                ...
                if (!checkSetMet(methods, fieldSetName)||filterField.contains(field.getName())) {
                    continue;
                }
