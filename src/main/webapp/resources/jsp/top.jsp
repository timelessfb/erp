		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
				<TR>
					...
					<TD background=../images/new_002.jpg><FONT size=5><B>闽三元染整漂染生产管理系统v1.0</B></FONT></TD>
							...
							<TBODY>
								...
								<TR>
									<TD height=35 align="right">
										当前用户：${ user.userName }
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="${pageContext.request.contextPath }/user_edit" target=main><FONT color=red>修改账号密码</FONT></A>
										&nbsp;&nbsp;&nbsp;&nbsp;
