...
<script type="text/javascript">
    ...
    $(function () {
        document.getElementById("userPassword").keyup(function () {
...
<BODY>
<FORM id=form1 name="form1" action="producer_log" method=post>
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px" width=150>
                                                <INPUT id="userPhoneno" style="WIDTH: 130px" name="phoneno" placeholder="用户电话号码" type="text"></TD>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px">
                                                <INPUT id="userPassword" style="WIDTH: 130px" type=password name="password" placeholder="密码" type="text"></TD>
                                            <TD style="HEIGHT: 28px">
