...
<BODY>
	<FORM id="customerForm" name="customerForm" action="findBynameOrPhonePro" method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：权限管理 &gt; 生产者列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>生产者电话：</TD>
													<TD><INPUT class=textbox id="phoneno"
															   style="WIDTH: 80px" maxLength=50 name="phoneno"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													<%--&nbsp;&nbsp;&nbsp;--%>
													<a href="${pageContext.request.contextPath }/deletePro?Id=${adminList.id}">删除</a>
													</TD>
												</TR>
