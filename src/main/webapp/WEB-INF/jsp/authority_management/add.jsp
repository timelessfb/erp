					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<div class="registerErrorMessageDiv">
							<div class="alert alert-danger" role="alert">
								...
								<span class="errorMessage">123145645648 </span>
							</div>
						</div>

						<TABLE cellSpacing=0 cellPadding=5  border=0 align="center" class="registerTable">
							<tr>
								<td  align="right"><b>设置管理员登录名</b></td>
								<td></td>
							</tr>
							<tr>
								<td  align="right">管理员登录名：</td>
								<td colspan="3"><input id="name" type="text" name="name" style="WIDTH: 180px" placeholder="登录名"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<INPUT class=textbox id="password" style="WIDTH: 180px" maxLength=50 name="password" placeholder="设置你的登陆密码">
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<INPUT class=textbox id="repeatpassword" style="WIDTH: 180px" maxLength=50 name="password" placeholder="请再次输入你的密码">
								</td>
							</tr>
							...
							<TR>
								...
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="phoneno" placeholder="11位电话号码">
								</td>
								<%--<td>联系人手机 ：</td>--%>
								<%--<td>--%>
